...
function Features() {
  return (
    <div className="max-w-screen-xl mx-auto px-4  md:mt-10 gap-12 text-gray-600 bg-[#FFD1D1] md:px-8">
    <h1 className="text-4xl space-y-5 max-w-4xl mx-auto  text-center text-[#850E35] font-extrabold  md:text-5xl">Ace your next job with a resume that speaks for you</h1>
      <div className="grid mt-10 md:mt-28 md:grid-cols-2 grid-cols-1  place-content-center gap-10 md:gap-40">
        ...
        <div>
          ...
          Transform your resume with our user-friendly editor.
          </h2>
