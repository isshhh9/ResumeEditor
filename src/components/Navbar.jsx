...
function Navbar() {
  ...
  return (
    <div className='flex shadow-sm items-center border-b-2 z-50 border-solid justify-between gap-4 px-1 py-3 bg-white sticky top-0 left-0 w-full'>
     ...
     <p
       onClick={() => navigate('/')}
       className='text-2xl font-[Roboto] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#cc537b] to-[#FF9494] cursor-pointer'
     >
       Resume Editor
     </p>
     </div>
    ...
    />
      ...
      }
     {
      ...
      <Button
        label='Download'
        classes='text-white bg-[#850E35] duration-150 hover:bg-indigo-500 active:bg-indigo-700 rounded-full py-2 px-5 flex items-center gap-2'
        icon={<BsDownload />}
